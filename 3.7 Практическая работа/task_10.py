...
print(a, b)
a = a + b # В этой строке мы меняем значение a путём сложения a и b
b = a - b # В этой строке мы меняем значение b путём вычитания из a наше число b
a = a - b # В этой строке мы меняем создаём новое значение a вычитая из a число b
print(a, b)
